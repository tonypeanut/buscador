...
// Vontenedor para los resultados
...
minimo.addEventListener('change', e =>{datosBusqueda.minimo=parseInt(e.target.value);filtrarAuto()})
maximo.addEventListener('change', e =>{datosBusqueda.maximo=parseInt(e.target.value);filtrarAuto()})
...
// Funciión que filtra en base a la búsqueda
...
function noResultado(){
    ...
    noResultado.textContent = 'No hay resultados para la búsqueda seleccionada. Prueba con otros datos.'
